...
fig = plt.figure()
bp = plt.boxplot(box_p+box_tau+box_wtau_x+results_tw,  vert = 1, patch_artist = True)

bp_colors = np.repeat([plt.cm.Pastel1(0), plt.cm.Pastel1(1), plt.cm.Pastel1(2), plt.cm.Pastel1(3)], [6, 6, 6, 6], axis=0)
bp_list = []
