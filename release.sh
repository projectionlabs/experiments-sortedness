...
echo "----------------- testing... -----------------------"
read -p "press enter"
poetry run pytest src --cov=src --doctest-modules
echo "----------------- tested -----------------------"
echo; echo
...
poetry run pdoc --html --force experimentssortedness -o docs
mv docs/experimentssortedness/* docs/
rm docs/experimentssortedness -rf
git add docs
